 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "prueba1.com", ownerName = "prueba1.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDlziCAnrfd4nFkA1fAKsCXySRtOoGamM8";
